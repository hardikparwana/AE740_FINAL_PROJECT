...
set(OMPL_INCLUDE_DIRS "${OMPL_INCLUDE_DIR};/usr/local/include;/usr/include/eigen3")
...
set(OMPL_LIBRARY_DIRS "${OMPL_LIBRARY_DIR};/usr/local/lib")
foreach(_dir ;;;;)
    if(_dir)
...
foreach(_lib /usr/local/lib/libboost_serialization.so;/usr/local/lib/libboost_filesystem.so;/usr/local/lib/libboost_system.so;ode;)
    if(_lib)
